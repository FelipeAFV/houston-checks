...
EXPECTED_INTEL_PROFILE_LOWER_RANGE="${NODE_EXPECTED_INTEL_PROFILE_LOWER_RANGE:-${EXPECTED_INTEL_PROFILE_LOWER_RANGE:-6}}"
EXPECTED_INTEL_PROFILE_UPPER_RANGE="${NODE_EXPECTED_INTEL_PROFILE_UPPER_RANGE:-${EXPECTED_INTEL_PROFILE_UPPER_RANGE:-7}}"
EXPECTED_AMD_PROFILE_REGEX="${NODE_EXPECTED_AMD_PROFILE_REGEX:-${EXPECTED_AMD_PROFILE_REGEX:-^(PerfPerWattOptimized|PerfPerWattOptimizedDapc|PerfPerWattOptimizedOS)$}}"

printf "EXPECTED_INTEL_PROFILE_LOWER_RANGE=%s\n" "$EXPECTED_INTEL_PROFILE_LOWER_RANGE"
printf "EXPECTED_INTEL_PROFILE_UPPER_RANGE=%s\n" "$EXPECTED_INTEL_PROFILE_UPPER_RANGE"
printf "EXPECTED_AMD_PROFILE_REGEX=%s\n" "$EXPECTED_AMD_PROFILE_REGEX"
